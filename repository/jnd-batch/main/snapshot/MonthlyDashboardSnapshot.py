...
class MonthlyDashboardDataSnapshot:
	...
	def createReindex(self):
		...
		try:
			...
			# index_list.append(base.constVar.DAILY_PRODUCE_REPORTER)
			# index_list.append(base.constVar.DAILY_PRODUCE_DEPART)
			# index_list.append(base.constVar.DAILY_PRODUCE_SECTION)
			# index_list.append(base.constVar.DAILY_PLATFORM_SUMMARY)
