import unittest
from main.job.PlatformSummaryJob import runner
from datetime import datetime, timedelta


class PlatformNewsSummaryTest(unittest.TestCase):

	def setUp(self) -> None:
		# self.runner = PlatformSummaryJobRunner()
		pass
...
if __name__ == '__main__':
	...
	suite = unittest.TestLoader().loadTestsFromTestCase(PlatformNewsSummaryTest)
