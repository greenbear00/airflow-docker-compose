import sys
import unittest
from main.job.ElectionSummaryRunner import runner
from datetime import datetime, timedelta



class ElectionSummaryRunnerTest(unittest.TestCase):

    def setUp(self) -> None:
        # self.runner = ElectionSummaryRunner()
        pass
...
if __name__ == '__main__':
    ...
    suite = unittest.TestLoader().loadTestsFromTestCase(ElectionSummaryRunnerTest)
